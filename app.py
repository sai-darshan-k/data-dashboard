...
def get_grok_recommendations(data):
    ...
    prompt = f"""
    You are an agricultural expert providing recommendations for Pomegranate in Flowering stage and Guava plants that is in Fruitning stage, based on last 24 hours sensor data from a farm:
    - Temperature: {temp} °C
    - Humidity: {humidity} %
